...
#define DEBUG 0 // for printing inside kernels
...
__constant__ unsigned int d_n2; // n2 = n / 2 stored in constant memory to avoid passing it as a parameter to the kernel
